...
//
//
//public func getData<T: Any>(from method: PrefferedMethod, for type: T.Type) async throws -> [T] {
//
//    var resultArray = [T]()
//
//    switch method {
//    case .automatic:
//        resultArray = try await getDataAutomatic(for: type)
//    case .database:
//        resultArray = getCamerasDataFromRealm()
//    case .network:
//        resultArray = try await getCamerasDataFromNetwork()
//    }
//
//    return cameras
//}
//
//private func getDataAutomatic<T: Any>(for type: T.Type) async throws -> [T] {
//
//    var resultArray = [T]()
//    var objectsOfType: RealmObjectType
//
//    switch type {
//    case is CameraModel.Type: objectsOfType = RealmObjectType.camera
//    case is DoorModel.Type: objectsOfType = RealmObjectType.door
//    default:
//        throw DataManagerError.invalidDataType
//    }
//
//    if RealmDataManager().isExists(objectsOfType: objectsOfType) {
//        switch type {
//        case is CameraModel.Type: resultArray = getDataFromRealm(type: RealmCamera.self) as! [T]
//        case is DoorModel.Type: resultArray = getDataFromRealm(type: RealmDoor.self) as! [T]
//        default:
//            throw DataManagerError.invalidDataType
//        }
//
...
//
//
//private func getDataFromRealm<T: RealmFetchable>(type: T.Type) -> [T] {
//
//    var resultArray = [T]()
//    let realmResult = RealmDataManager().read(for: T.self)
//
//
//    realmResult.forEach { element in
//        let elementForArray = T
//        resultArray.append(elementForArray)
//    }
//
//    return cameras
//}
